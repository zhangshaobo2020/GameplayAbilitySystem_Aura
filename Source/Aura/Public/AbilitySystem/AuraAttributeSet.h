...
public:
	...
	/*
	 * TODO: 需要加强理解
	 * 如何从DECLARE_DELEGATE_RetVal的BindStatic拓展到TBaseStaticDelegateInstance
	 * TBaseStaticDelegateInstance<FGameplayAttribute(), FDefaultDelegateUserPolicy>::FFuncPtr等价于FGameplayAttribute(*)()
	 * 进而想到使用函数指针的方案
	 */
	...
	FGameplayAttributeData CriticalHitResistance; // 暴击率减免
	...
	FGameplayAttributeData ManaRegeneration; // 法力值回复
	...
	FGameplayAttributeData LightingResistance; // 雷电抗性
